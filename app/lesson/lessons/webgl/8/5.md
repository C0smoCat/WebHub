...
Еще одной моделью освещения является модель освещения Ламберта. Модель Ламберта намного проще модели Фонга, так как учитывает только одну составляющую - 
диффузное отражение.

Собственно на уровне кода веб-странички реализация освещения будет похожей за тем исключением, что в ней мы будем использовать 
только цвет диффузного отражения и цвет диффузной поверхности:
