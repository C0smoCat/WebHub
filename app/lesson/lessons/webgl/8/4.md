...
Применение материалов в WebGL по сути не привносит ничего сложного. Мы просто определяем для каждого типа отражения свой материал и передаем его в вершинный 
шейдер. Код веб-странички будет следующим:
...
В плане кода настройка, передача в шейдер и использование материалов ничем не отличается от использования цветов освещения. В итоге наш куб будет выглядеть 
следующим образом:

![Использование материалов в WebGL](https://metanit.com/web/webgl/pics/8.6.png)
